...
CREATE TABLE `movies` (
  ...
  `movie_ image` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `movies` (`id`, `movie_name`, `movie_desc`, `movie_quality`, `movie_rating`, `movie_ image`) VALUES
...
INSERT INTO `users` (`id`, `emri`, `username`, `email`, `password`, `comfirm_password`, `is_admin`) VALUES
